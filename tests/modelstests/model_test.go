...
func seedOneUser() (models.User, error) {
	...
	refreshUserTable() // xoá và tạo table
...
func seedOneUserAndOnePost() (models.Post, error) {
	...
	err := refreshUserAndPostTable() // xoá và tạo user and post table
	if err != nil {
		return models.Post{}, err
	}
	// insert 1 bản ghi vào bảng table
	user := models.User{
		Username: "Sam Phil",
		Email:    "sam@gmail.com",
		Password: "password",
	...
	// insert 1 bản ghi vào post table vì có trường user id là forenkey
	post := models.Post{
...
func seedUsersAndPosts() ([]models.User, []models.Post, error) {
	...
	// Thêm nhiều bản ghi vào bảng user and post
